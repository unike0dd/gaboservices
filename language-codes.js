...
export const DICTIONARY = {
  ...
  es: {
    ...
    aboutBodyP1: 'En Gabriel Services, sabemos que el crecimiento de una empresa no depende solo de grandes decisiones, sino de la calidad con la que se ejecuta cada operación diaria.',
    aboutBodyP2: 'Nuestra experiencia como antiguos propietarios de pequeñas empresas y profesionales de soporte empresarial remoto nos ha permitido entender, de primera mano, que la eficiencia, la comunicación clara y la consistencia operativa no son opcionales: son la base de un negocio sólido. A lo largo de nuestra trayectoria en servicio al cliente, logística, soporte técnico, administración y operaciones, hemos comprobado que los pequeños detalles, cuando no se gestionan correctamente, pueden convertirse en costos, retrasos y fricciones innecesarias.',
    aboutBodyP3: 'Por eso apoyamos a las empresas para que se mantengan organizadas, ágiles y operativamente fuertes. Combinamos experiencia práctica, adaptabilidad y una mentalidad centrada en el cliente para responder a los retos del día a día con un enfoque confiable, eficiente y consciente de costos.',
    aboutBodyP4: 'Nuestro propósito es fortalecer la operación diaria de cada negocio, para que sus líderes puedan concentrarse en lo más importante: planificar con claridad, dirigir con seguridad y crecer con confianza.',
    name: 'Nombre',
